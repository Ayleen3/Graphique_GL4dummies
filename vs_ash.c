...
void credits_init_ash(void) {
  int i;
  SDL_Surface * t;
  int vp[4], w, h;
  static char * files[] = {"./images/pika_fond.jpeg","./images/vs_ash.png","./images/vs_ash2.png","./images/vs_ash3.png","./images/vs_ash4.png","./images/vs_ash5.png","./images/vs_ash6.png"};
...
void credits_draw_ash(void) {
  ...
  gl4duPushMatrix(); {
    gl4duScalef(300, 250, 100);
    gl4duRotatef(a0, 0, 0, 0);
    gl4duTranslatef(0.2, -0.4, -4); //taille vs
