...
void credits_init_blondie(void) {
  int i;
  SDL_Surface * t;
  int vp[4], w, h;
  static char * files[] = {"./images/charizard_fond.jpg","./images/vs_blondie.png","./images/vs_blondie2.png","./images/vs_blondie3.png","./images/vs_blondie4.png","./images/vs_blondie5.png","./images/vs_blondie6.png"};
...
void credits_draw_blondie(void) {
  ...
  //Cynthia
  glActiveTexture(GL_TEXTURE0);
  glBindTexture(GL_TEXTURE_2D, _tId[((image/12)%6)+1]);
  gl4duPushMatrix(); {
    gl4duScalef(300, 250, 100);
    gl4duRotatef(a0, 0, 0, 0);
    gl4duTranslatef(0.2, 0.4, -4);
