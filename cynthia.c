...
void credits_init_cynthia(void) {
  int i;
  SDL_Surface * t;
  int vp[4], w, h;
  static char * files[] = {"./images/fond.png","./images/cynthia1.png","./images/cynthia2.png","./images/cynthia3.png","./images/cynthia4.png"};
...
void credits_draw_cynthia(void) {
  ...
  gl4duPushMatrix(); {
    gl4duScalef(300, 250, 100);
    gl4duRotatef(a0, 0, 0, 0);
    gl4duTranslatef(-0.2, -0.2, -2); //taille de cynthia
