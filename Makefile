...
HEADERS = projetanim.h projetaudio.h
SOURCES = projetanim.c projetwindow.c projetaudio.c vs_ash.c vs_blondie.c charizard_pika.c cynthia.c pokeball.c pika_charizard.c ash.c pokeball_2.c pokeball_tourne.c pokeball_tourne_floue.c credits.c
OBJ = $(SOURCES:.c=.o)
DOXYFILE = documentation/Doxyfile
EXTRAFILES = COPYING shaders/basic.vs shaders/mix.fs shaders/basic.fs shaders/base.vs shaders/base.fs toto.mp3 index.png shaders/earth.vs shaders/earth.fs	\
takeonme.mod land_ocean_ice_2048_glossmap.png fond.png
